  ...
  return (
    <footer className='bg-black w-full py-8 px-4 md:py-16'>
      ...
      <div className='flex items-center gap-2 justify-center mb-4 md:hidden'>
        <Link href='/contact' className='text-white text-sm md:text-base hover:opacity-80 transition-opacity'>
          Contact us
        </Link>
        <span className='w-1 h-1 rounded-full bg-gray-600'></span>
        <Link href='/' className='text-white text-sm md:text-base hover:opacity-80 transition-opacity'>
          About us
        </Link>
      </div>
